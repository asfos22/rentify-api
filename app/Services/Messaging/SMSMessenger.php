...
class SMSMessenger implements MessengerInterface
{
    ...
    public function __construct(Client $client, string $from, PushMessageRepositoryInterface $repository, LoggerInterface $logger, bool $fake = false)
    {
        $this->client = $client;
     ...
     */
    public function fetchForUser(Account $user): array
    {
        return [];
    }
     ...
     */
    public function countForUser(Account $user): int
    {
        return 0;
    }
